@echo off
title Naomika Design Studio - Localhost Server & Admin Dashboard
color 0B
echo ===================================================
echo     Naomika Design Studio - Local Server & Admin
echo ===================================================
echo.
...
echo [1/3] Syncing latest products spreadsheet...
node sync_store.js

echo [2/3] Opening Naomika Admin Dashboard in browser...
start "" "http://localhost:3000/admin"

echo [3/3] Starting Local Server on http://localhost:3000...
echo Keep this window open while previewing or managing the studio!
